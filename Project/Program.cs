        ...
        public static void Work()
        {
            ...
            switch (Console.ReadKey().Key)
            {
                case ConsoleKey.D1:
                    {
                        Console.WriteLine();
                        task1.Work(Console.ReadLine());
                        break;
                    }
                case ConsoleKey.D2:
                    {
                        Console.WriteLine();
                        task2.Work(Console.ReadLine(), Console.ReadLine());
                        break;
                    }
                case ConsoleKey.D3:
                    {
                        Console.WriteLine();
                        task3.Work(Console.ReadLine(), Console.ReadLine(), Console.ReadLine());
                        break;
                    }
                case ConsoleKey.D4:
                    {
                        Console.WriteLine();
                        task4.Work(Console.ReadLine());
                        break;
                    }
            }
        }
